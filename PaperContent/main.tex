...
\hline
\textbf{Graph ID} & \boldmath\textbf{Pattern Grid Side Length \boldmath\((l)\) \unboldmath}\unboldmath & \textbf{Pattern Type} & \textbf{Number of Vertices \boldmath\((n)\) \unboldmath} & \textbf{Number of Edges \boldmath\((m)\) \unboldmath} & \textbf{Number of Regions} \\
\hline
